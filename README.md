# Домашнее задание к занятию "`Индексы`" - `Савин Алексей`
...
```
![1](https://github.com/AI-Savin/SQL_Index/blob/main/img/1.png)  
...
```
## Вариант с удалением ненужной выборки из запроса  
Как понимаю данный запрос выдает платежи людей, взявших в аренду фильмы за определенную дату. В запросе, на мой взгляд, много лишней информации: например, инвентаризация (inventory_id), дата аренды (rental_date), фильмы (film). Из-за чего исходный запрос получился на 16615 милисекунд (16 сек) и прочитанных строк вышло 642000.

Я решил пойти путем удаления ненужной информации.
...
```
![2](https://github.com/AI-Savin/SQL_Index/blob/main/img/2.png)  
...
## Вариант с созданием индекса для даты платежа  
...
```
Вывод анализа. Скорость обработки с индексом стала быстрее по сравнению с вариантом данным по заданию и с тем где я убрал лишнюю выборку из запроса.  
```
...
```
![2_1](https://github.com/AI-Savin/SQL_Index/blob/main/img/2_1.png)  
